...
// Can display a 4-digit positive number or a 3-digit negative
...
void writeLedDisplay(int value) {
	...
	// Split value up into individual digits
	int hundreds = (value % 1000) / 100;
	int tens = (value % 100) / 10;
	int units = value % 10;
	
	spi_writeWord(1, units);
